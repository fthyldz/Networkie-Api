...
namespace Networkie.Persistence.Migrations
{
    ...
    [Migration("20250510084734_UserUniversities_OptionalEntryYear")]
    partial class UserUniversities_OptionalEntryYear
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Networkie.Entities.User", b =>
                {
                    ...
                    b.Property<bool?>("IsSeekingForJob")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Networkie.Entities.UserUniversity", b =>
                {
                    ...
                    b.HasKey("UserId", "UniversityId", "DepartmentId");

                    b.HasIndex("DepartmentId");

                    b.HasIndex("UniversityId");

                    b.HasIndex("UserId", "UniversityId", "DepartmentId", "EntryYear")
                        .IsUnique();
            ...
            modelBuilder.Entity("Networkie.Entities.UserSocialPlatform", b =>
                {
                    b.HasOne("Networkie.Entities.SocialPlatform", "SocialPlatform")
                        .WithMany()
            ...
            modelBuilder.Entity("Networkie.Entities.UserUniversity", b =>
                {
                    b.HasOne("Networkie.Entities.Department", "Department")
                        .WithMany()
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Networkie.Entities.University", "University")
                        .WithMany()
