...
public record CompleteProfileDto(string PhoneCountryCode, string PhoneNumber, Gender Gender, DateTime BirthOfDate, bool IsEmployed, bool IsSeekingForJob, bool IsHiring, string? Profession, Guid? ProfessionId, List<CompleteProfileUniversityDto> Universities, string? Country, Guid? CountryId, string? State, Guid? StateId, string? City, Guid? CityId, string? District, Guid? DistrictId, List<CompleteProfileSocialPlatformDto> SocialPlatforms);

public record CompleteProfileSocialPlatformDto(Guid SocialPlatformId, string? Url);

public record CompleteProfileUniversityDto(string? University, Guid? UniversityId, string? Department, Guid? DepartmentId, short? EntryYear);
...
public class CompleteProfileSocialPlatformDtoValidator : AbstractValidator<CompleteProfileSocialPlatformDto>
{
...
public class CompleteProfileUniversityDtoValidator : AbstractValidator<CompleteProfileUniversityDto>
{
