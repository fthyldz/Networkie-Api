...
public class EmploymentChartQueryHandler(
    ...
    : IQueryHandler<EmploymentChartQuery, IResult<EmploymentChartQueryResult>>
{
    public async Task<IResult<EmploymentChartQueryResult>> Handle(EmploymentChartQuery query, CancellationToken cancellationToken)
    {
        ...
        var chartData = await userRepository.GetEmploymentChart(filter, cancellationToken);
        
        var result = new EmploymentChartQueryResult(chartData.IsEmployed, chartData.IsNotEmployed);
        
        return SuccessResult<EmploymentChartQueryResult>.Create(result);
    }
}